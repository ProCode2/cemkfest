...
const firebaseProdConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_PROD_FIREBASE_AUTHA_DOMAIN,
  databaseURL: process.env.NEXT_PUBLIC_PROD_FIREBASE_DATABASE_URL,
  projectId: process.env.NEXT_PUBLIC_PROD_FIREBASE_PROJECT_ID,
  storageBucket: process.env.NEXT_PUBLIC_PROD_FIREBASE_STORAGE_BUCCKET,
  messagingSenderId: process.env.NEXT_PUBLIC_PROD_FIREBASE_MESSEAGING_ID,
  appId: process.env.NEXT_PUBLIC_PROD_FIREBASE_APP_ID,
  measurementId: process.env.NEXT_PUBLIC_PROD_FIREBASE_MEASURMENT_ID,
};
